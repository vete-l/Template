...
public class ExternalNativeBuildOptionsModel extends GradleDslBlockModel {
  public ExternalNativeBuildOptionsModel(@NotNull ExternalNativeBuildOptionsDslElement dslElement) {
    super(dslElement);
  }
  ...
  public CMakeOptionsModel cmake() {
    ...
    return new CMakeOptionsModel(cMakeOptionsDslElement);
  }
  ...
  public NdkBuildOptionsModel ndkBuild() {
    ...
    return new NdkBuildOptionsModel(ndkBuildOptionsDslElement);
  }
