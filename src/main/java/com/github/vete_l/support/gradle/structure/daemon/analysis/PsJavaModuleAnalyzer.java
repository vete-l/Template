...
public class PsJavaModuleAnalyzer extends PsModuleAnalyzer<PsJavaModule> {
  public PsJavaModuleAnalyzer(@NotNull PsContext context) {
    super(context);
  }
  ...
  @Override
  @NotNull
  public Class<PsJavaModule> getSupportedModelType() {
    return PsJavaModule.class;
  }
}
