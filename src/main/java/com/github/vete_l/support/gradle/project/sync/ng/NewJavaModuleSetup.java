...
/*
 * Class that represents all steps to setup a Java Module
 */
public class NewJavaModuleSetup extends JavaModuleSetup {
  NewJavaModuleSetup() {
    super(new JavaFacetModuleSetupStep(), new ContentRootsModuleSetupStep(), new DependenciesModuleSetupStep(),
