 ...
 */
package com.github.vete_l.support.gradle.variant.conflict;
...
public class Conflict {
  ...
  public String toString() {
    ...
    if (expectedVariants.size() == 1) {
      ...
      Collection<AffectedModule> modules = getModulesExpectingVariant(expectedVariant);
  ...
  private static String getModuleNames(@NotNull Collection<AffectedModule> modules) {
    if (modules.size() == 1) {
      AffectedModule module = ContainerUtil.getFirstItem(modules);
      assert module != null;
